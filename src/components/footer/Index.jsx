                ...
                <div className="footer-wrapper">
                    <div className="footer-elements">
                        ...
                        <ul className="footer-list">
                            <li className="footer-list-item"><img src={footer1} alt="photo" />
                            </li>
                            <li className="footer-list-item"><img src={footer2} alt="photo" />
                            </li>
                            <li className="footer-list-item"><img src={footer3} alt="photo" />
                            </li>
                            <li className="footer-list-item"><img src={footer4} alt="photo" />
                            </li>
                        </ul>
                    </div>
                    <div className="footer-elements">
                        <h3 className="footer-title">Explore</h3>
                        <a href="#" className="footer-text">Marketplace</a>
                        <a href="#" className="footer-text">Rankings</a>
                        <a href="#" className="footer-text">Connect a wallet</a>
                    </div>
                    <div className="footer-elements">
