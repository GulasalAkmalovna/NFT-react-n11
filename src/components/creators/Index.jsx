        ...
        <section id='creators'>
            <div className="container min-h-[100px] m-auto   px-[30px]">
                ...
                <div className='craetor-card flex flex-col gap-[16px] items-center justify-center flex-wrap sm:grid grid-cols-2'>
                    {
                        creators.map(item => {
                            return <div key={item.id} className='response-card w-full min-w-[305px] text-[#fff] flex items-center gap-[20px] p-[20px] min-h-[100px] relative bg-[#3B3B3B] rounded-[20px]'>
                                <div className='font2 w-[30px] h-[30px] bg-[#2B2B2B] rounded-full flex items-center justify-center text-[16ox] absolute top-[18px] left-[20px]'>{item.id}</div>
                                <div>
                                    <img className='image-craetors w-[80px] h-[80px]' src={item.url} alt="" />
                                </div>
                                <div>
                                    <h4 className='text-[22px] leading-[30.8px] font-[600] mb-[6px] capitalize'>{item.name}</h4>
                                    <ul>
                                        <li ><span className='text-[#858584] mr-[8px] text-[16px] leading-[22.4px]'>Total Sales:</span><span className='font2'>{item.price}</span></li>
                                    </ul>
                                </div>
                            </div>
                        })
