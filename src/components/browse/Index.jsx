        ...
        <section id='browse' className='py-[40px]  mt-[60px]'>
            <div className="container m-auto  w-full text-white  px-[30px]">
                ...
                <div className='flex flex-wrap gap-[20px] items-center justify-center md:grid grid-cols-4 justify-center '>
                    {
                        arts.map(art => {
                            return <div key={art.id} className='md:mb-[20px]'>
                                <div className='w-full max-w-[200px] min-h-[142px] rounded-t-[20px]  overflow-hidden md:w-full max-w-[260px] flex items-center justify-center'>
                                    <img src={art.url} className=' max-w-[200px] object-contain md:min-w-[260px] object-cover' alt="photos" />
                                </div>
                                <div className='bg-[#3B3B3B] max-w-[150px] rounded-b-[20px] md:max-w-[260px] min-h-[90px] py-[30px] px-[24px]' >
