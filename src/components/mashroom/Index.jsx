...
import mashroom from '../../images/bgImage.png'
                ...
                <div className="container m-auto  px-[30px]">
                    <div className="magic-wrapper">
                        <div className="magic-content">
                            ...
                            <button className="magic-btn second"><img src={eye} alt="photo" /> <span>See
                                NFT</span></button>
                        </div>
                        ...
                        <button className="magic-btn"><img src={eye} alt="" /> <span>See NFT</span></button>
                    </div>
                </div>
            </div>
        </section>
