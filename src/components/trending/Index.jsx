                        ...
                        trendingArr.map(item => {
                            return <div key={item.id}>
                                <div className='trend-card w-[330px] h-[330px]'>
                                    <img className='trending-picture' src={item.Url} alt="photo" />
                                </div>
                                <ul className='flex items-center justify-between mt-[16px]'>
                                    <li className='trend-card'><img className='trending-picture' src={item.thumbUrl} alt="photo" /></li>
                                    <li className='trend-card'><img className='trending-picture' src={item.thumbUrl2} alt="photo" /></li>
                                    <li className='counts w-[100px] h-[100px] bg-[#A259FF] rounded-[20px] flex items-center justify-center font-[700] leading-[22.4px] md:text-[22px] leading-[35.2px] xl:'>{item.count}</li>
                                </ul>
                            </div>
                        })
                    }
